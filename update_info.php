...
<?php
  ...
  if(isset($_GET['appointment_no'])){
    ...
    while($row = $result->fetch_array())
    {
      ...
      echo "$link Doctor's Suggestions - $mid" . "<form action='update_info.php' method='post'><textarea class='form-group form-control' name='upSugg' style='resize: none;'></textarea><input type='number' style='visibility: hidden; width; 1px;' name='appointment_no' value =". $appointment_no . "><input type='submit' class='btn btn-primary'></form>" . "$endingTag";
      echo "</tr>";
    }
  }
?>

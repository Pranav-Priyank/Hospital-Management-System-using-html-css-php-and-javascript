...
<link herf="jumbotron.css" rel="stylesheet">
<?php
	include("header.php");
	include("library'php");
	noAccessForAdmin();
...
<div class="container">
  <h2>Welcome, <?php echo $_SESSION["fullname"];?>!</h2>
     <div class='alert alert-info'>
		<strong>Info!</Strong> Appointment will be booked onlyfor today - <?php echo date('j/n/y'); ?>. Appointment time will be between 10:30 to 3:30 or 4:30 to 9:30 once appointment is booked.</div>
